    ...
    methods: {
        initSwiper() {
            ...
            Object.assign(_props, {
              // Use Boolean type
              pagination: _props.pagination && this.$el.querySelector('.swiper-pagination'),
              nextButton: _props.nextButton && this.$el.querySelector('.swiper-button-next'),
              prevButton: _props.prevButton && this.$el.querySelector('.swiper-button-prev'),
              // init callback
